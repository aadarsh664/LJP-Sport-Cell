...
export const translations = {
  en: {
    ...
    noticePlaceholder: "Type notice here..."
  },
  hi: {
    ...
    allBihar: "संपूर्ण बिहार",
    publishNotice: "सूचना प्रकाशित करें",
    noticePlaceholder: "सूचना यहाँ टाइप करें..."
  },
  hn: {
    appTitle: "LJP Sports Cell",
    ...
    enhanced: "Enhanced",
    useEnhanced: "Use Enhanced Version",
    schedule: "Schedule Karein",
    meetingTitle: "Meeting Title",
    allBihar: "All Bihar",
    publishNotice: "Notice Publish Karein",
    noticePlaceholder: "Notice yahan likhein..."
  }
};
...
export const handleSmartTransliteration = async (text: string, sourceScript: 'en' | 'hi'): Promise<string> => {
  if (!text) return "";

  if (sourceScript === 'en') {
    return await fetchTransliteration(text);
  }
  ...
  if (sourceScript === 'hi') {
    const phoneticMap: Record<string, string> = {
      ...
      '्': '', 'ड़': 'd', 'ढ़': 'dh', 'ज्ञ': 'gya', 'क्ष': 'ksh', 'त्र': 'tr'
    };

    let englishSpelling = '';
    for (let i = 0; i < text.length; i++) {
      englishSpelling += phoneticMap[text[i]] !== undefined ? phoneticMap[text[i]] : text[i];
    }
    return englishSpelling.charAt(0).toUpperCase() + englishSpelling.slice(1);
  }

  return text;
};

export const DISTRICTS_HI: Record<string, string> = {
...
export const DESIGNATIONS_HI: Record<string, string> = {
  'Pradesh Adhyaksh': 'प्रदेश अध्यक्ष',
  'Zila Adhyaksh': 'जिला अध्यक्ष',
  'Prakhand Adhyaksh': 'प्रखंड अध्यक्ष',
  'Ward Sadasya': 'वार्ड सदस्य',
