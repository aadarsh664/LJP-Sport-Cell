            ...
            {isNotifOpen && (
                <div className="fixed inset-0 z-[70]">
                    ...
                    <div className="absolute top-0 right-0 h-full w-full md:w-96 bg-white dark:bg-gray-900 shadow-2xl animate-slide-in flex flex-col">
                        <div className="p-4 md:p-5 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-gray-50 dark:bg-gray-900">
                            <h2 className="text-base md:text-lg font-bold flex items-center gap-2 dark:text-white"><Bell size={18} className="text-ljp-secondary" /> Notice History</h2>
                            ...
                            {sortedNotices.length === 0 ? (
                                ...
                                sortedNotices.map(notice => (
                                    <div 
                                        ...
                                        className="bg-white dark:bg-gray-800 p-3 md:p-4 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50"
                                    >
                                        ...
                                        <p className="text-xs md:text-sm font-semibold text-gray-800 dark:text-gray-200 line-clamp-2">{notice.content}</p>
                                    </div>
                                ))
                            )}
                        </div>
