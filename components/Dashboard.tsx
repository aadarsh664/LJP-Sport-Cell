        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center space-x-4">
                    ...
                    <div>
                        <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">{t.totalMembers}</p>
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center space-x-4">
                    ...
                    <div>
                        <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">{t.pendingApprovals}</p>
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center space-x-4">
                    ...
                    <div>
                        <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">{t.activeDistricts}</p>
                        <p className="text-2xl font-bold text-gray-900 dark:text-white">{activeDistricts}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
                <div className="p-6 border-bottom border-gray-100 dark:border-gray-800 flex items-center justify-between">
                ...
                <div className="divide-y divide-gray-100 dark:divide-gray-800">
                    {notices.length > 0 ? (
                        notices.map((notice) => (
                            <div key={notice.id} className="p-6 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    <button 
                                        ...
                                        className="flex items-center space-x-1 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                                    >
                                        <FileText size={14} />
                                    ...
                                    <button 
                                        ...
                                        className="flex items-center space-x-1 px-3 py-1.5 bg-ljp-secondary/10 text-ljp-secondary dark:text-blue-400 rounded-lg text-sm font-medium hover:bg-ljp-secondary/20 transition-colors"
                                    >
                                        <Download size={14} />
                                    ...
                                    {(currentUser?.role === Role.SUPER_ADMIN || currentUser?.role === Role.SUB_ADMIN) && (
                                        <button 
                                            onClick={() => onEnhanceNotice(notice)}
                                            className="flex items-center space-x-1 px-3 py-1.5 bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 rounded-lg text-sm font-medium hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors"
                                        >
                                            <Sparkles size={14} />
