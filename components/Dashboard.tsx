...
import { Language, translations, DESIGNATIONS_HI } from '../services/translations';
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-gray-900 p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center space-x-4">
                    ...
                    <div>
                        <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 font-medium">{t.totalMembers || 'Total Members'}</p>
                ...
                {currentUser?.role !== Role.MEMBER && (
                    <div className="bg-white dark:bg-gray-900 p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center space-x-4">
                        ...
                        <div>
                            <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 font-medium">{t.pendingApprovals || 'Pending Approvals'}</p>
                ...
                <div className="bg-white dark:bg-gray-900 p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center space-x-4">
                    ...
                    <div>
                        <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 font-medium">{t.totalLocations || 'Total Locations'}</p>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
                ...
                <div className="divide-y divide-gray-100 dark:divide-gray-800">
                    {notices.length > 0 ? (
                        notices.map((notice) => {
                            const noticeUser = users.find(u => u.id === notice.userId);
                            const displayName = currentLang === 'hi' && noticeUser ? (noticeUser.name_hi || notice.userName) : notice.userName;
                            const displayDesig = currentLang === 'hi' && noticeUser ? (DESIGNATIONS_HI[noticeUser.designation] || notice.userDesignation) : notice.userDesignation;
                                    ...
                                    <div className="flex justify-between items-start mb-3">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-500 dark:text-gray-400">{displayDesig}</p>
                                            </div>
                                        </div>
